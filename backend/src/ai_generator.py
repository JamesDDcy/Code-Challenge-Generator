# LLM that will help us generate a challenge
import os
import json
...
def generate_challenge_with_ai(difficulty: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # This takes the returned string from openAi and convert it into a python dict which we return
        ...
        print(e)
        # If we had an error with openAi we return a default question
        return {
